/* Copyright (C) 2021 AnshidZx7

re-edited by AnshidZx7
...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By Doraemon' : process.env.ALL_CAPTION,
    ...
    GIF_WEL: process.env.GIF_WEL === undefined ? 'https://c.tenor.com/QNtFLycfQiAAAAPo/pika-Doraemon.mp4' : process.env.GIF_WEL,
    ...
    SAID: process.env.BGM_DURATION === undefined ? '11111:00:00' : process.env.BGM_DURATION,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? ' Doraemon bot' : process.env.BOT_NAME,
    ...
    SUDO: process.env.SUDO === undefined ? '918590451659,0' : process.env.SUDO,
    ...
    SUPPORT: "918590451659-1627138839",

    SUPPORT2: "9185473 80133-1632403322",

    SUPPORT3: "9196051 01516-1621015274"
